...
if "%SUPABASE_INTENT_LLM_FAILURE_TABLE%"=="" set "SUPABASE_INTENT_LLM_FAILURE_TABLE=chatbot_intent_model_failures"
if "%SUPABASE_QA_LLM_FAILURE_TABLE%"=="" set "SUPABASE_QA_LLM_FAILURE_TABLE=chatbot_qa_model_failures"
